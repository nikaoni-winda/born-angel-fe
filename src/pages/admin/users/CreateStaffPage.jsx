        ...
        <AdminLayout>
            <div className="max-w-2xl mx-auto">
                <div className="mb-8 flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-polar-night">Create Staff</h1>
                        <p className="text-text-primary/60 text-sm">Add a new admin to the team</p>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-[2rem] border border-polar-night/5 shadow-sm p-8">
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        {/* Info Box */}
                        <div className="bg-frost-byte/10 border border-frost-byte/20 rounded-xl p-4">
                            <p className="text-xs text-polar-night/70">
                                <span className="font-bold">Note:</span> This will create a new admin account with full access to manage services, schedules, instructors, and bookings.
                            </p>
                        </div>
